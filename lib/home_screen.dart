...
import 'AdminScreen.dart'; // Add this import for AdminScreen
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<String> courses = ['Our courses', 'Tests and quizzes', 'Progress Tracker'];
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 3) { // Profile/Admin tab
      // Mock check for admin status (replace with real logic later, e.g., from backend)
      bool isAdmin = true; // For now, hardcoded to true for testing
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => isAdmin ? const AdminScreen() : const ProfileScreen(),
        ),
      );
    }
  }
