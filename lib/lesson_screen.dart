...
class _LessonScreenState extends State<LessonScreen> {
  ...
  Widget build(BuildContext context) {
    final lesson = widget.lessons.isNotEmpty ? widget.lessons[_currentLessonIndex] : 'No Lessons Available';
    final imagePath = lesson == 'Introduction to Driving'
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ] else if (lesson == 'Vehicle Familiarization & Controls') ...[
                        const Text(
                          'What You’ll Learn:',
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _currentLessonIndex < widget.lessons.length - 1 ? _nextLesson : null,
                    style: ElevatedButton.styleFrom(
